...
## 技术栈：
  react + redux + webpack + react-router + ES6 + immutable


## 运行项目（nodejs 6.0+）

```
 git@github.com:Wfy9526/react-ele-account.git

 cd ele-account\my-account
...
>  利用闲暇时间学习了react相关知识，尝试利用react全家桶来写一个简单项目加深对react的理解
路由配置拆分怎么做？
动态加载怎么做？
props怎么传递？
登录拦截怎么做？
...
>  以下的个人感悟是我从一开源项目上Copy过来的，总结的很到位，值得一看
